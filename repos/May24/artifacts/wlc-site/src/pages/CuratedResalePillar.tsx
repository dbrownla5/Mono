        ...
        <div className="container">
          ...
          <div style={{ maxWidth: 720 }}>
            {[
              ...
              { q: "How do I know my items are being handled correctly?", a: "You'll receive a monthly report of every sale — item, platform, price, and net proceeds. I don't keep anything without documentation. Consignment agreements are in place before anything leaves your home." },
            ].map((item, i) => (
        ...
        <div className="container">
          <FadeUp>
            <div style={{ maxWidth: 600 }}>
              <h2 className="display-md" style={{ color: "var(--parchment)", marginBottom: "1.5rem" }}>Ready to let it go — thoughtfully?</h2>

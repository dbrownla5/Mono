        ...
        <div className="container">
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "0" }}>
            {[
              ...
              { category: "Transitions & Support", items: ["Post-move settling and unpacking", "Support after loss or major change", "Preparing a home for a new resident", "Downsizing assistance", "Estate support coordination"] },

...
const faqSections = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "How do I pay?", a: "For services (The Reset, House Calls, Legacy), payment is due at the time of service. I accept Venmo, Zelle, and check. For Curated Resale and Fast Bag Fill, there's no upfront payment — you're paid from proceeds after items sell. Retainer clients are billed monthly." },

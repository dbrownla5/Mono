/*
 * PILLAR 03 — HOUSE CALLS
 * The Well Lived Citizen
 * Copy: verbatim from FOLDER_3 Service Page 03 (Adjusted/Tightened — locked)
 * Voice: conversion-first, observational, no case studies on the page
 * The Gayle story and "vintage means vinyl" belong in social/blog — not here.
 */
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.1fr", gap: "5rem", alignItems: "start" }}>
            <FadeUp>
              ...
              <h2 className="display-md" style={{ color: "var(--ink)", marginBottom: "2rem" }}>
                The world changed. The process got heavier.
              </h2>
              ...
              <p className="body-lg">
                It is for the people who suddenly find themselves handling the parts of home life someone else used to quietly carry. The bill that used to auto-resolve. The appliance install that feels different when you're home alone. The digital login that somehow became intimidating overnight. The package, pickup, repair, donation, or appointment that shouldn't be a big deal but suddenly feels heavier than it should.
              </p>
            </FadeUp>
            ...
            <FadeUp delay={80}>
              <div style={{ backgroundColor: "var(--parchment-mid)", padding: "2.5rem", boxShadow: "6px 6px 0px var(--sage)" }}>
                ...
                {[
                  ...
                  "Event prep, logistical setup, and post-event breakdown (for private hosting, dinners, and home events)",
                ].map((item, i) => (
        ...
        <div className="container">
          <FadeUp>
            <div style={{ maxWidth: 720 }}>
              ...
              <h2 className="display-md" style={{ color: "var(--ink)", marginBottom: "2rem" }}>
                It's not about capability. It's about bandwidth.
              </h2>
              <p className="body-lg" style={{ marginBottom: "1.5rem" }}>
        ...
        <div className="container">
          <FadeUp>
            <div style={{ maxWidth: 680 }}>
              ...
              <h2 className="display-md" style={{ color: "var(--ink)", marginBottom: "2rem" }}>
                I become the person who handles it.
              </h2>
          ...
          <FadeUp>
            <div style={{ maxWidth: 600 }}>
              <h2 className="display-md" style={{ color: "var(--parchment)", marginBottom: "1.5rem" }}>
                Ready to get some things handled?
              </h2>

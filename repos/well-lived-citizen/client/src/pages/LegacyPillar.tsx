/*
 * PILLAR 02 — LEGACY PLANNING & INVENTORY CATALOG
 * The Well Lived Citizen
 * Copy: verbatim from Brand OS locked copy + FOLDER_3 Legacy Inventory
 * Voice: grounded, emotionally perceptive, no sentimentality spiral
 * Rule: "Oh I could use that. Duh, why didn't I think of that?" → book.
 */
        ...
        <div className="container">
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1.1fr", gap: "5rem", alignItems: "start" }}>
            <FadeUp>
              ...
              <p className="body-lg" style={{ marginBottom: "1.5rem" }}>
                When a home transitions — through a move, a health change, a death, or simply a decision to downsize — the people left to sort through it often have no record of what anything is, what it's worth, or what the person who owned it would have wanted done with it.
              </p>
              <p className="body-lg">
            ...
            <FadeUp delay={80}>
              <div style={{ backgroundColor: "var(--parchment-mid)", padding: "2.5rem", boxShadow: "6px 6px 0px var(--sage)" }}>
                ...
                {[
                  ...
                  "Financial and estate paperwork routing",
            ...
            {[
              {
                ...
                body: "I start with a full walkthrough of the home to understand scope, prioritize rooms, and identify items that need special handling — appraisal, family attribution, or immediate routing decisions.",
              },
              {
                step: "02",
                title: "Photography & Documentation",
                body: "Every significant item is photographed and cataloged with condition notes, provenance details, and any known history. The catalog becomes a permanent record the family can reference.",
              },
              {
                step: "03",
                title: "Valuation Routing",
                body: "Items that may have significant value are flagged for appraisal. I work with trusted appraisers and can coordinate that process — I don't guess at value, and I don't let things leave the house without a record.",
              },
              {
                step: "04",
                title: "Distribution Planning",
                body: "Once the catalog is complete, I work through distribution with you — what goes to family, what goes to resale, what gets donated, and what needs special handling. The decisions are yours. The logistics are mine.",
              },
            ].map((item, i) => (
        ...
        <div className="container">
          <FadeUp>
            <div style={{ maxWidth: 680 }}>
              ...
              <h2 className="display-md" style={{ color: "var(--ink)", marginBottom: "2rem" }}>
                Before the conversation becomes urgent.
              </h2>
              ...
              <p style={{ fontSize: "0.72rem", fontWeight: 600, letterSpacing: "0.14em", textTransform: "uppercase", color: "var(--ink)", opacity: 0.55, marginTop: "0.75rem" }}>
                — Dayna Brown, Founder
              </p>
            </div>
          </FadeUp>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "start" }}>
              <div>
                ...
                <h2 className="display-md" style={{ color: "var(--ink)", marginBottom: "1rem" }}>
                  Scoped by project.<br />Always disclosed upfront.
                </h2>

...
**Phone / Preferred Contact:** ___________________________
**Intake Reference:** #___________________________
...
Commission is calculated on the **net sale price** — the gross sale price after platform fees, shipping costs, and approved transaction expenses are deducted before the split is applied. No upfront fees are charged. Commission is earned only upon a completed sale.

| Category | Client Receives | WLC Retains |
|---|---|---|
| Clothing & Accessories | 55% | 45% |
| Designer & Luxury | 55% | 45% |
| Furniture & Significant Home Pieces | 55% | 45% |
| Full Closet Liquidation | 55% | 45% |
| Low-Value Volume (primarily $5–$10 resale range) | 35% | 65% |
...
## 3. Item Evaluation & Acceptance

The Consultant reserves the right to decline any item that, in her professional judgment, is unlikely to sell, is damaged beyond reasonable resale condition, or is a counterfeit or unauthorized reproduction.
...
## 4. Item Prep & Presentation

The Consultant is authorized to make reasonable prep decisions where modest preparation meaningfully improves resale outcome. This may include lint rolling, steaming, polishing, spot treatment, leather care, minor repairs, and thoughtful presentation and packaging.
...
The 30-day consignment period begins on the date this agreement is signed. The Client's first payout will be issued on the first Monday following the close of that initial 30-day window, covering all completed sales to that point. Subsequent payouts are issued monthly — first Monday following each 30-day period.
...
## 9. Pickup Confirmation & Inventory Review

Pickup confirmation — whether by photo, courier confirmation, or UPS delivery — serves as the record that goods were received and custody transferred. This confirms receipt only.

Within 48 hours of receipt, the Client will receive an inventory confirmation including tote count, broad item summary, category overview, and any obvious exclusions or issues. The Client has **48 hours** from inventory confirmation to raise any concerns about missing or incorrectly logged items. Discrepancies reported after this window may not be actionable.

Following inventory confirmation, a **7–10 business day review period** begins. During this period the Consultant evaluates resale viability, platform routing, pricing, prep requirements, and commission tier. Items may be declined during this window.

---

## 10. Unsold Items & 180-Day Review

Most items with strong second-market demand sell within 6–9 months, though timing varies by category, pricing, seasonality, platform behavior, and buyer demand.
...
Items awaiting pickup, declined at evaluation, or paused at Client request may be held for a limited operational window only. Retrieval must be coordinated within **14 days** of the Consultant's notice unless otherwise agreed in writing. Items not retrieved within that window may be donated, rerouted, or responsibly cleared after reasonable contact attempts.

---

## 12. Item Provenance & Story Sharing

Part of the value The Well Lived Citizen brings to curated resale — particularly for vintage, luxury, inherited, or one-of-a-kind pieces — is the story behind the item. Provenance, origin, and context are shared as part of the listing and sales process when they add value.
...
## 13. Content & Photography Release

The Consultant may photograph, style, and document items for use in listings, business marketing, social media, and portfolio content. This includes item photography, packaging, curation imagery, before/after details, and listing screenshots. No Client names, addresses, or identifying personal information will be included in any public-facing content.
...
The Client is the seller of record for all items consigned through this agreement. Any tax obligations arising from resale proceeds are solely the Client's responsibility. The Well Lived Citizen is an independent contractor and reseller — not a payment processor, employer, or tax agent. No tax advice is provided and no tax documents will be issued by The Well Lived Citizen in connection with resale proceeds.

---

## 15. Termination

Either party may terminate this agreement with **7 days written notice**. Upon termination, unsold items will be returned to the Client within **14 days**. Items already listed or in active transit at the time of termination will be handled to completion under the original commission terms.

---

## 16. Governing Law

This agreement is governed by the laws of the State of California. Any disputes will be resolved in Los Angeles County.

---

## Signatures

By signing below, both parties confirm they have read and agree to the terms of this Consignment Agreement. Electronic signatures are legally binding under the California Uniform Electronic Transactions Act (Cal. Civ. Code § 1633.1 et seq.).
...
*The Well Lived Citizen · Los Angeles, CA · thewelllivedcitizen.com*
*A Well Dressed Citizen LLC company*
